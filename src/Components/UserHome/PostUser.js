  ...
  const [comments,setComments] =useState([
    {
        ...
        username:"Srihari P",
        time:"3 Hours Ago",
        comment:"Srihari P,seasoned Software Engineer with 2Years of experience in designing, developing, and deploying high-quality software solutions. With expertise in Full Stack , e.g., Python, Java, or full-stack development], they specialize in building scalable applications that meet client needs. Their career is marked by notable achievements, including [specific projects or contributions]. A proactive problem-solver, Agrisense excels in team collaborations and has contributed significantly to [specific industry/domain, e.g., fintech, e-commerce]."
    },
    {
        id:2,
        profilePic:img2,
    ...
    },
    {
        ...
        username:"Harsha",
        time:"30 Mins Ago",
        comment:"Interested Creating Web Applications"
    }
])
